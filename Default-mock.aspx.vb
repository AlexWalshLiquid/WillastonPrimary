...
Partial Class Default_mock
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        DirectCast(Master.FindControl("scissorsDIV"), HtmlGenericControl).Visible = True
	 	...
	 	Dim mpTitleLT As Literal = DirectCast(Master.FindControl("mpTitleLT"), Literal)
        mpTitleLT.Visible = True
        mpTitleLT.Text = "Willaston Church of England Primary School"
